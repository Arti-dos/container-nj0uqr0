...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-nj0uqr0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-nj0uqr0.containers.anotherwebservice.com/
...
```
git clone git@github.com:Arti-dos/container-nj0uqr0.git
cd container-nj0uqr0
```
...
```
docker attach container-nj0uqr0
```
